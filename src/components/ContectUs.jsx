...
import { RiLinkedinBoxFill, RiTwitterXLine, RiInstagramLine } from "react-icons/ri";
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                <div className="p-3 rounded-full bg-primary/10">
                                    <IoMailOpenOutline className="h-6 w-6 text-primary" />
                                    {" "}
                                </div>
                                <div>
                            ...
                            <div className="flex items-start space-x-4">
                                <div className="p-3 rounded-full bg-primary/10">
                                    <MdPhoneInTalk className="h-6 w-6 text-primary" />{" "}
                                </div>
                                <div>
                                    <h4 className="font-medium"> Phone</h4>
                                    <a
                                        href="tel:+917091966895"
                                        className="text-muted-foreground hover:text-primary transition-colors"
                                    >
                                        +91 7091-966-895
                                    </a>
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs">
                        ...
                        <form className="space-y-6">
                            ...
                            <button type="submit" disabled={isSubmitting} className={cn("cosmic-button w-full flex items-center justify-center gap-2")}>
                                {isSubmitting ? "Sending..." : "Send Message"}<LuSend className='h-4 w-4' />
                            </button>
                        </form>
                    </div>
                </div>
