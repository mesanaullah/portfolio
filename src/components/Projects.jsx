...
const projects = [
    ...
    
    {
        ...
        tags: ["React", "TailwindCSS", "Node.js", "MongoDB"],
        demoUrl: "#",
        githubUrl: "https://github.com/mesanaullah/NewsApp",
    },
];
        ...
        <section id="projects" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                    {" "}
                    My <span className="text-primary"> Latest Work </span>
                </h2>
                ...
                <div className="text-center mt-12">
                    <a className="cosmic-button w-fit flex items-center mx-auto gap-2"
                        target="_blank"
                        href="https://github.com/mesanaullah"
                    >
                        Check My Github<BiLogoGithub className='w-5 h-5' />
                    </a>
                </div>
            </div>
        </section>
